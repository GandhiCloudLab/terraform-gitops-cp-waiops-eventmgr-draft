...
variable "entitlement_key" {
  type        = string
  description = "The entitlement key used to access the waiops images in the container registry. Visit https://myibm.ibm.com/products-services/containerlibrary to get the key"
  sensitive   = true
}
